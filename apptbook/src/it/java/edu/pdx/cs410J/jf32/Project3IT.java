...
public class Project3IT extends InvokeMainTestCase
{
    ...
    void testDateFormatReturn() {
        InvokeMainTestCase.MainMethodResult result = invokeMain("Joe", "\"test\"", "fakeDate", "1:00", "6/2/2021", "2:00");
        assertThat(result.getExitCode(), equalTo(1));
    ...
    void testNumberOfArgumentsMoreThenMAx() {
        InvokeMainTestCase.MainMethodResult result = invokeMain("-print", "-textfile","file","Joe", "\"test\"", "6/2/2021", "1:00", "6/2/2021", "2:00", "additional argument");
        assertThat(result.getExitCode(), equalTo(1));
        assertThat(result.getTextWrittenToStandardError(), containsString("Number of arguments is incorrect. Please check command line arguments."));
    }
}
